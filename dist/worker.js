 ...
 */
export async function checkFile(fileToCheck, options) {
...
Your response will not get directly sent to the user, but instead will be combined with the responses of every other files generated. So please keep your answer short. If this file does not raise any concerns/problems that the users has asked, then just return "This passes your criteria". If there are causes for concern, please list just very short bullet points on why you are concerned.`;
		// Create AI thread
 ...
 */
export async function processFiles(files, options, taskQueue, onProgress) {
	const results = [];
	let completed = 0;
